...
(function () {
  ...
  const section = document.querySelector('body.page-id-510 #property-5005');
  ...
  videoLink.addEventListener('click', function (event) {
    ...
    overlay.innerHTML = '<div class="rr-video-dialog" role="dialog" aria-modal="true" aria-labelledby="rr-video-title"><div class="rr-video-bar"><h2 id="rr-video-title"></h2><button type="button" class="rr-video-close" aria-label="Close video">×</button></div><div class="rr-video-frame"><iframe title="5005 63rd St video tour" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen referrerpolicy="strict-origin-when-cross-origin"></iframe></div></div>';
    overlay.querySelector('#rr-video-title').textContent = '5005 63rd St video tour';
