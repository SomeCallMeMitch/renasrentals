(function () {
  ...
  function buildCard(card, number) {
    ...
    const detailsUrl = copyText('details_url');
    const details = element(detailsUrl ? 'a' : 'span', 'rr-card-button rr-card-button--details', copyText('details_label'));
    if (detailsUrl) details.href = detailsUrl;
