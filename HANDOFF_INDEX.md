...
| --- | --- | --- | --- |
| 2026-09-24 | Next chat: property details page | Details page **not built**; client will co-design it in the next chat. Start from the local WordPress preview, preserve the Beaver Builder text / Listing Gallery image boundary, and use the handoff to avoid repeating the earlier hardcoding mistake. | [PROPERTY_DETAILS_PAGE_NEXT_CHAT_HANDOFF.md](PROPERTY_DETAILS_PAGE_NEXT_CHAT_HANDOFF.md) |
| 2026-09-24 | Beaver Builder text ownership correction | Added seven local Beaver Builder “Mobile Card Copy” modules and changed the local mobile cards to read all visible property copy from Beaver Builder; Listing Gallery remains the photo source. Checked seven phone cards at 320px and desktop at 1100px. Local only; no production deployment. | [reference/wordpress-local-mobile-preview/README.md](reference/wordpress-local-mobile-preview/README.md#editing-the-phone-card-text) |
| 2026-09-24 | Earlier Beaver Builder editability finding | The earlier review found hardcoded phone-card text. **Superseded by the correction above**; retain as historical context only. | [reference/wordpress-local-mobile-preview/README.md](reference/wordpress-local-mobile-preview/README.md#editing-the-phone-card-text) |
| 2026-09-24 | Mobile availability badge | Local-only phone cards now show “Available” and its date on one line in a compact green badge. Checked at 320px and 390px with all seven cards present and no horizontal overflow; live site unchanged. | [reference/wordpress-local-mobile-preview/README.md](reference/wordpress-local-mobile-preview/README.md) |
