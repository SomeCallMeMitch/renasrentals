...
| --- | --- | --- | --- |
| 2026-09-24 | Beaver Builder editability of mobile cards | Verified in plugin source: Beaver Builder supplies several property values, but the phone card layout, green badge styling, fixed location/walk text, and controls are code-driven. No website change in this review. | [reference/wordpress-local-mobile-preview/README.md](reference/wordpress-local-mobile-preview/README.md#beaver-builder-editability) |
